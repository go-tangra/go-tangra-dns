...
// The DNS UI is a federated remote served by the module under /ui/ and
// relayed by the gateway at /m/dns/; `vite` alone runs a standalone dev
...
export default defineConfig({
  ...
  test: {
    environment: 'jsdom',
    environmentOptions: { jsdom: { url: 'https://localhost/dns' } },
